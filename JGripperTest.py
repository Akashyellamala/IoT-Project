...
def main():
    ...
    while True:
        user_input = input("Press 'X' for J1-90°, 'Y' for J1--90°, 'Z' for J2-90°,'U' for J2--90°, 'C' for J3--90°,'R' for J3-90°, 'T' for J4-90°,'B' for J4--90°, 'G' to open gripper, 'H' to close gripper, or 'Q' to quit: ").upper()
        if user_input == 'X':
            ...
            print("Invalid input. Please press 'X', 'Y', 'Z', 'U', 'C', 'R', 'T', 'B', 'G', 'H', or 'Q'.")
